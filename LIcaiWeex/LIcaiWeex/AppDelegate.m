...
//    [WXDevTool launchDevToolDebugWithUrl:@"ws://192.168.51.47:8088/debugProxy/native"];
    
    ViewController2 *v2 = [[ViewController2 alloc]init];
    UINavigationController *nav=[[UINavigationController alloc]initWithRootViewController:v2];
